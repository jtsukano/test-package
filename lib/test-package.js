...
export default {
  ...
  search(query, language) {
    return new Promise((resolve, reject) => {
      ...
      let searchString = `${query} in ${language} site:http://blog.davidsingleton.org/sudoku/`
  ...
  scrape(html) {
    $ = cheerio.load(html)
    // return $('div.accepted-answerr pre code').text(
    return $('pre').last().text()
    // console.log($('pre').last().text()))
  },
